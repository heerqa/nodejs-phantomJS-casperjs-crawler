...
import addWishListWhenNoID from 'addWishListWhenNoID';
import addShippingAddress from 'addShippingAddress';
import addProductToWishlist from 'addProductToWishlist';
let system = require('system');
let args = system.args;
let fs = require('fs');
let x = require('casper').selectXPath;
let page = require('webpage').create();
let utils = require('utils');
var _ = require('lodash');
let wlName = "wl"+Math.floor((Math.random() * 100) + 1);
let wishlistID_new;
...
args.forEach(function(arg, i) {
    if(i > 0 && arg[0] == '{'){
      ...
      //Without wishlist
      //parameters = JSON.parse('{"account": "heer17@yopmail.com", "password": "At123456789", "dbc_login": "user555", "dbc_password": "qWW@8!yB7&", "gc": "1234-1234-1234-1234", "items": [ {"ASIN":"B00DUGZFWY", "qty":"3", "url":""},   {"ASIN":"B005EJH6Z4", "qty":"3", "url":""}],  "billing_address": {"full_name": "Mr Punto", "street1": "Some Mission St", "street2": "",  "city":"Tampa", "state":"FL",  "zip":"33605",  "country":"US", "phone":"1234567890"}}');
       //With wishlist
        //parameters = JSON.parse('{"account": "heer15@yopmail.com", "password": "At123456789", "dbc_login": "user555", "dbc_password": "qWW@8!yB7&", "gc": "1234-1234-1234-1234","wishlist_id": "2M9U2XJ7T00HA", "items": [ {"ASIN":"B00SCD17PY", "qty":"3", "url":""},   {"ASIN":"B00KMRGF3M", "qty":"3", "url":""}],  "billing_address": {"full_name": "Mr Sylvestor", "street1": "Some Mission St", "street2": "",  "city":"Tampa", "state":"FL",  "zip":"33605",  "country":"US", "phone":"1234567890"}}');
    }
});
...
if(!parameters.account || !parameters.password || !parameters.gc){
    console.log('Please pass as an argument a JSON object like: {"account": "amazon@account.com", "password": "password", "gc": "1234-1234-1234-1234"}');
    phantom.exit(1);
}
...
function resolveCaptcha(imageFN, onResolved){
    ...
    page.open(
        ...
        '<input type="text"     name="username" value="' + parameters.dbc_login + '"> ' +
        '<input type="password" name="password" value="' + parameters.dbc_password + '"> ' +
...
var addasin="http://amazon.com/dp/0071809252";
...
}else{ //wishlist is part of input JSON, add items to this wishlist
